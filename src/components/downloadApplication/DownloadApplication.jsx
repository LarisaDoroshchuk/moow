...
const DownloadApplication = () => {
    ...
    return (
        <div className="downloadApplication_wrapper">
            ...
            <a href="!#" className="downloadApplication_button-link  link_web">Почати працювати через браузер </a>

            <section className="downloadApplication_block-btn">

                <a href="https://play.google.com/" className="downloadApplication_button-link  link-googlePlay">Завантажити додаток з Google Play </a>
                <a href="https://www.apple.com/ua/app-store/" className="downloadApplication_button-link  link-appStore">Завантажити додаток з App Store</a>
