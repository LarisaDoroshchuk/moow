...
const LastQuestions = () => {
    ...
    return (
        <div className="lastQuestions_wrapper">
            ...
            <div class="lastQuestions_container">
                ...
                <section className="lastQuestions_block-btn">
                    <a href="!#" class="lastQuestions_button-link  link-faq">Перейди до FAQ</a>
                    <a href="!#" class="lastQuestions_button-link  link-chat">Написати через чат-бот</a>
                </section>
